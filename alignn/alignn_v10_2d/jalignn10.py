"""
Predict band gaps with ALIGNN on Alexandria PBE 2D.
...
`atoms.elements` when the top-level key is missing.

Outputs: results/alignn_predictions.json
  Each entry: {id, formula, band_gap_ind, band_gap_dir, e_form, alignn_bandgap}
"""
