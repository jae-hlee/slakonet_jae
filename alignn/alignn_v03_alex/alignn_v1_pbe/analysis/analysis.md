...
- ALIGNN entries without SK match (excluded): **17553** (~99.9 % are lanthanide-containing cells that SlakoNet silently rejects, not recoverable by rerun — see `../../analysis/analysis.md`)
