"""
Predict formation energy (eV/atom) with ALIGNN on the filtered Alexandria
PBE 3D dataset (e_above_hull == 0, elements Z <= 65), mirroring
alignn_v03_alex/alignn_v1_pbe and the v03 paired benchmark.
...
Outputs: results/alignn_eform_predictions.json
  Each entry: {mat_id, formula, band_gap_ind, band_gap_dir, e_form, alignn_eform_per_atom}
"""
