...
alignn_slakonet/              ALIGNN runs grouped by source dataset
  alslak_v03_alex/            Alexandria PBE 3D hull (paired with slakonet/slako_v03_alex)
    slako_v03/                SlakoNet baseline on the paired set
    alslak_v1_pbe/            ALIGNN  mp_gappbe_alignn       (label-matched)
    alslak_v2_mbj/            ALIGNN  jv_mbj_bandgap_alignn  (TB-mBJ)
    alslak_v3_opt/            ALIGNN  jv_optb88vdw_bandgap_alignn
...
From `alignn_slakonet/alslak_v03_alex/comprehensive_analysis/`. Reference is Alexandria PBE indirect gap.
...
|-----------------------------------------------------------------------------|--------------------------------------------------------------|
| `slako_v03_alex`, `slako_v11_alexwz`, `slako_v12_all`, `alslak_v03_alex/alslak_v{1,2,3}_*`   | `alexandria_pbe_3d_2024.10.1_jarvis_tools.json.zip` (1.1 GB) |
