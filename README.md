...
- **Element support.** SlakoNet ships Slater–Koster parameters for Z ≤ 65 (up to terbium); heavier elements are filtered out up front. For Alexandria 3D this retains ~48 k of the original ~196 k `e_above_hull == 0` structures.
